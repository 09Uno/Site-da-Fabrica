...
$(document).ready(function() {
    ...
    function carouselBx() {
        ...
        if (windowWidth > 800) {
            ...
            var carBannerlength = $('.carousel-banner li').length;

            if (carBannerlength > 2) {
                $('.carousel-banner1').bxSlider({
                    slideWidth: 287,
                    minSlides: 4,
                    maxSlides: 4,
                    slideMargin: 0
    ...
    function parallax() {
        ...
        $('.bg3').css('top', -(scrolled * 0.5) + 'px');
        $('.bg4').css('top', -(scrolled * 0.5) + 'px');
    }
    ...
    $("#formContato").submit(function(e){
      ...
      $.ajax({
          ...
          success: function(result){
              if(result.msg == 1){
                $(".inputFrmContato").val('');
                $("#msgSucessoContato").fadeIn(500).fadeOut(5000);
              } else {
                $("#msgErroContato").fadeIn(500).fadeOut(5000);
              }
    ...
    $('#cd-main-nav ul li').each(function(){ 
        $(this).click(function() {
